...
class DynamicPlanner:
    ...
    def _build_system_prompt(self) -> str:
        ...
        # This is the "constitution" of the agent.
        prompt_template = f"""
...
## ЗАДАНИЕ:
Проанализируй историю и свою основную задачу. Какой **один** следующий шаг нужно сделать?
Ответь **только** в формате JSON, содержащем один следующий шаг. Не добавляй никаких других слов или комментариев.
...
{{
  ...
  "description": "Проверяю содержимое текущей директории для ориентирования."
}}
```
"""
